		...
		<>
			<header className=" flex items-center justify-center mt-20  px-4 mx-auto  ">
				<div className="flex  ">
					...
					<ul className="hidden  md:flex items-center p-8 gap-7 ">
						<Link
							to="/"
							className="p-4 font-bold hover:scale-125 duration-300 rounded-xl hover:bg-cyan-200/30"
						>
							Home
						</Link>
						<Link
				...
				<div onClick={handleOpenMenuMobile} className="block md:hidden">
					{!menuMobile ? (
					...
					>
						<ul className=" z-10 uppercase relative  flex flex-col pt-24 h-screen bg-[#0CCBFF] ">
							<Link to={'/'} className="p-4 font-bold hover:opacity-60">
								Home
							</Link>
							<Link to={'/about'} className="p-4 font-bold hover:opacity-60 ">
								About
							</Link>
							<Link
								to={'/appointment'}
							...
							<Link to={'/others'} className="p-4 font-bold hover:opacity-60">
								Our Services
							</Link>
